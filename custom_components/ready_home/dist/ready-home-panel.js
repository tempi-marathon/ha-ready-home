 ...
 */const q=globalThis,W=q.ShadowRoot&&(q.ShadyCSS===void 0||q.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,K=Symbol(),G=new WeakMap;let dt=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==K)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(W&&t===void 0){const i=e!==void 0&&e.length===1;i&&(t=G.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&G.set(e,t))}return t}toString(){return this.cssText}};const mt=s=>new dt(typeof s=="string"?s:s+"",void 0,K),gt=(s,...t)=>{const e=s.length===1?s[0]:t.reduce((i,r,o)=>i+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+s[o+1],s[0]);return new dt(e,s,K)},$t=(s,t)=>{if(W)s.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const i=document.createElement("style"),r=q.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=e.cssText,s.appendChild(i)}},X=W?s=>s:s=>s instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return mt(e)})(s):s;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:yt,defineProperty:bt,getOwnPropertyDescriptor:vt,getOwnPropertyNames:xt,getOwnPropertySymbols:wt,getPrototypeOf:At}=Object,I=globalThis,tt=I.trustedTypes,Ct=tt?tt.emptyScript:"",Et=I.reactiveElementPolyfillSupport,T=(s,t)=>s,B={toAttribute(s,t){switch(t){case Boolean:s=s?Ct:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,t){let e=s;switch(t){case Boolean:e=s!==null;break;case Number:e=s===null?null:Number(s);break;case Object:case Array:try{e=JSON.parse(s)}catch{e=null}}return e}},Z=(s,t)=>!yt(s,t),et={attribute:!0,type:String,converter:B,reflect:!1,useDefault:!1,hasChanged:Z};Symbol.metadata??=Symbol("metadata"),I.litPropertyMetadata??=new WeakMap;let S=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=et){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const i=Symbol(),r=this.getPropertyDescriptor(t,i,e);r!==void 0&&bt(this.prototype,t,r)}}static getPropertyDescriptor(t,e,i){const{get:r,set:o}=vt(this.prototype,t)??{get(){return this[e]},set(n){this[e]=n}};return{get:r,set(n){const a=r?.call(this);o?.call(this,n),this.requestUpdate(t,a,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??et}static _$Ei(){if(this.hasOwnProperty(T("elementProperties")))return;const t=At(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(T("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(T("properties"))){const e=this.properties,i=[...xt(e),...wt(e)];for(const r of i)this.createProperty(r,e[r])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[i,r]of e)this.elementProperties.set(i,r)}this._$Eh=new Map;for(const[e,i]of this.elementProperties){const r=this._$Eu(e,i);r!==void 0&&this._$Eh.set(r,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const r of i)e.unshift(X(r))}else t!==void 0&&e.push(X(t));return e}static _$Eu(t,e){const i=e.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const i of e.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return $t(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ET(t,e){const i=this.constructor.elementProperties.get(t),r=this.constructor._$Eu(t,i);if(r!==void 0&&i.reflect===!0){const o=(i.converter?.toAttribute!==void 0?i.converter:B).toAttribute(e,i.type);this._$Em=t,o==null?this.removeAttribute(r):this.setAttribute(r,o),this._$Em=null}}_$AK(t,e){const i=this.constructor,r=i._$Eh.get(t);if(r!==void 0&&this._$Em!==r){const o=i.getPropertyOptions(r),n=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:B;this._$Em=r;const a=n.fromAttribute(e,o.type);this[r]=a??this._$Ej?.get(r)??a,this._$Em=null}}requestUpdate(t,e,i,r=!1,o){if(t!==void 0){const n=this.constructor;if(r===!1&&(o=this[t]),i??=n.getPropertyOptions(t),!((i.hasChanged??Z)(o,e)||i.useDefault&&i.reflect&&o===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,i))))return;this.C(t,e,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,e,{useDefault:i,reflect:r,wrapped:o},n){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??e??this[t]),o!==!0||n!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(e=void 0),this._$AL.set(t,e)),r===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[r,o]of this._$Ep)this[r]=o;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[r,o]of i){const{wrapped:n}=o,a=this[r];n!==!0||this._$AL.has(r)||a===void 0||this.C(r,void 0,o,a)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(e)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(t){}firstUpdated(t){}};S.elementStyles=[],S.shadowRootOptions={mode:"open"},S[T("elementProperties")]=new Map,S[T("finalized")]=new Map,Et?.({ReactiveElement:S}),(I.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Q=globalThis,it=s=>s,D=Q.trustedTypes,rt=D?D.createPolicy("lit-html",{createHTML:s=>s}):void 0,ht="$lit$",b=`lit$${Math.random().toFixed(9).slice(2)}$`,ut="?"+b,St=`<${ut}>`,C=document,O=()=>C.createComment(""),P=s=>s===null||typeof s!="object"&&typeof s!="function",Y=Array.isArray,kt=s=>Y(s)||typeof s?.[Symbol.iterator]=="function",V=`[ 	
\f\r]`,L=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,st=/-->/g,ot=/>/g,w=RegExp(`>|${V}(?:([^\\s"'>=/]+)(${V}*=${V}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),nt=/'/g,at=/"/g,pt=/^(?:script|style|textarea|title)$/i,Lt=s=>(t,...e)=>({_$litType$:s,strings:t,values:e}),h=Lt(1),y=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),lt=new WeakMap,A=C.createTreeWalker(C,129);function _t(s,t){if(!Y(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return rt!==void 0?rt.createHTML(t):t}const Nt=(s,t)=>{const e=s.length-1,i=[];let r,o=t===2?"<svg>":t===3?"<math>":"",n=L;for(let a=0;a<e;a++){const l=s[a];let u,c,p=-1,g=0;for(;g<l.length&&(n.lastIndex=g,c=n.exec(l),c!==null);)g=n.lastIndex,n===L?c[1]==="!--"?n=st:c[1]!==void 0?n=ot:c[2]!==void 0?(pt.test(c[2])&&(r=RegExp("</"+c[2],"g")),n=w):c[3]!==void 0&&(n=w):n===w?c[0]===">"?(n=r??L,p=-1):c[1]===void 0?p=-2:(p=n.lastIndex-c[2].length,u=c[1],n=c[3]===void 0?w:c[3]==='"'?at:nt):n===at||n===nt?n=w:n===st||n===ot?n=L:(n=w,r=void 0);const _=n===w&&s[a+1].startsWith("/>")?" ":"";o+=n===L?l+St:p>=0?(i.push(u),l.slice(0,p)+ht+l.slice(p)+b+_):l+b+(p===-2?a:_)}return[_t(s,o+(s[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class R{constructor({strings:t,_$litType$:e},i){let r;this.parts=[];let o=0,n=0;const a=t.length-1,l=this.parts,[u,c]=Nt(t,e);if(this.el=R.createElement(u,i),A.currentNode=this.el.content,e===2||e===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(r=A.nextNode())!==null&&l.length<a;){if(r.nodeType===1){if(r.hasAttributes())for(const p of r.getAttributeNames())if(p.endsWith(ht)){const g=c[n++],_=r.getAttribute(p).split(b),v=/([.?@])?(.*)/.exec(g);l.push({type:1,index:o,name:v[2],strings:_,ctor:v[1]==="."?Mt:v[1]==="?"?Ot:v[1]==="@"?Pt:z}),r.removeAttribute(p)}else p.startsWith(b)&&(l.push({type:6,index:o}),r.removeAttribute(p));if(pt.test(r.tagName)){const p=r.textContent.split(b),g=p.length-1;if(g>0){r.textContent=D?D.emptyScript:"";for(let _=0;_<g;_++)r.append(p[_],O()),A.nextNode(),l.push({type:2,index:++o});r.append(p[g],O())}}}else if(r.nodeType===8)if(r.data===ut)l.push({type:2,index:o});else{let p=-1;for(;(p=r.data.indexOf(b,p+1))!==-1;)l.push({type:7,index:o}),p+=b.length-1}o++}}static createElement(t,e){const i=C.createElement("template");return i.innerHTML=t,i}}function k(s,t,e=s,i){if(t===y)return t;let r=i!==void 0?e._$Co?.[i]:e._$Cl;const o=P(t)?void 0:t._$litDirective$;return r?.constructor!==o&&(r?._$AO?.(!1),o===void 0?r=void 0:(r=new o(s),r._$AT(s,e,i)),i!==void 0?(e._$Co??=[])[i]=r:e._$Cl=r),r!==void 0&&(t=k(s,r._$AS(s,t.values),r,i)),t}class Tt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,r=(t?.creationScope??C).importNode(e,!0);A.currentNode=r;let o=A.nextNode(),n=0,a=0,l=i[0];for(;l!==void 0;){if(n===l.index){let u;l.type===2?u=new U(o,o.nextSibling,this,t):l.type===1?u=new l.ctor(o,l.name,l.strings,this,t):l.type===6&&(u=new Rt(o,this,t)),this._$AV.push(u),l=i[++a]}n!==l?.index&&(o=A.nextNode(),n++)}return A.currentNode=C,r}p(t){let e=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class U{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,r){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=k(this,t,e),P(t)?t===d||t==null||t===""?(this._$AH!==d&&this._$AR(),this._$AH=d):t!==this._$AH&&t!==y&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):kt(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==d&&P(this._$AH)?this._$AA.nextSibling.data=t:this.T(C.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,r=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=R.createElement(_t(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.p(e);else{const o=new Tt(r,this),n=o.u(this.options);o.p(e),this.T(n),this._$AH=o}}_$AC(t){let e=lt.get(t.strings);return e===void 0&&lt.set(t.strings,e=new R(t)),e}k(t){Y(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,r=0;for(const o of t)r===e.length?e.push(i=new U(this.O(O()),this.O(O()),this,this.options)):i=e[r],i._$AI(o),r++;r<e.length&&(this._$AR(i&&i._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const i=it(t).nextSibling;it(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class z{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,r,o){this.type=1,this._$AH=d,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=d}_$AI(t,e=this,i,r){const o=this.strings;let n=!1;if(o===void 0)t=k(this,t,e,0),n=!P(t)||t!==this._$AH&&t!==y,n&&(this._$AH=t);else{const a=t;let l,u;for(t=o[0],l=0;l<o.length-1;l++)u=k(this,a[i+l],e,l),u===y&&(u=this._$AH[l]),n||=!P(u)||u!==this._$AH[l],u===d?t=d:t!==d&&(t+=(u??"")+o[l+1]),this._$AH[l]=u}n&&!r&&this.j(t)}j(t){t===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Mt extends z{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===d?void 0:t}}class Ot extends z{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==d)}}class Pt extends z{constructor(t,e,i,r,o){super(t,e,i,r,o),this.type=5}_$AI(t,e=this){if((t=k(this,t,e,0)??d)===y)return;const i=this._$AH,r=t===d&&i!==d||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,o=t!==d&&(i===d||r);r&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Rt{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){k(this,t)}}const Ut=Q.litHtmlPolyfillSupport;Ut?.(R,U),(Q.litHtmlVersions??=[]).push("3.3.3");const Ht=(s,t,e)=>{const i=e?.renderBefore??t;let r=i._$litPart$;if(r===void 0){const o=e?.renderBefore??null;i._$litPart$=r=new U(t.insertBefore(O(),o),o,void 0,e??{})}return r._$AI(s),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const J=globalThis;let M=class extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ht(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return y}};M._$litElement$=!0,M.finalized=!0,J.litElementHydrateSupport?.({LitElement:M});const qt=J.litElementPolyfillSupport;qt?.({LitElement:M});(J.litElementVersions??=[]).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const E={ATTRIBUTE:1,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},Bt=s=>(...t)=>({_$litDirective$:s,values:t});class Dt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const It=s=>s.strings===void 0,zt={},Ft=(s,t=zt)=>s._$AH=t;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const N=Bt(class extends Dt{constructor(s){if(super(s),s.type!==E.PROPERTY&&s.type!==E.ATTRIBUTE&&s.type!==E.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!It(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[t]){if(t===y||t===d)return t;const e=s.element,i=s.name;if(s.type===E.PROPERTY){if(t===e[i])return y}else if(s.type===E.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(i))return y}else if(s.type===E.ATTRIBUTE&&e.getAttribute(i)===t+"")return y;return Ft(s),t}});/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jt={attribute:!0,type:String,converter:B,reflect:!1,hasChanged:Z},Vt=(s=jt,t,e)=>{const{kind:i,metadata:r}=e;let o=globalThis.litPropertyMetadata.get(r);if(o===void 0&&globalThis.litPropertyMetadata.set(r,o=new Map),i==="setter"&&((s=Object.create(s)).wrapped=!0),o.set(e.name,s),i==="accessor"){const{name:n}=e;return{set(a){const l=t.get.call(this);t.set.call(this,a),this.requestUpdate(n,l,s,!0,a)},init(a){return a!==void 0&&this.C(n,void 0,s,a),a}}}if(i==="setter"){const{name:n}=e;return function(a){const l=this[n];t.call(this,a),this.requestUpdate(n,l,s,!0,a)}}throw Error("Unsupported decorator location: "+i)};function F(s){return(t,e)=>typeof e=="object"?Vt(s,t,e):((i,r,o)=>{const n=r.hasOwnProperty(o);return r.constructor.createProperty(o,i),n?Object.getOwnPropertyDescriptor(r,o):void 0})(s,t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function $(s){return F({...s,state:!0,attribute:!1})}async function Wt(s){return s.connection.sendMessagePromise({type:"ready_home/settings"})}async function Kt(s,t){return s.connection.subscribeMessage(t,{type:"ready_home/subscribe"})}async function Zt(s,t){return s.connection.sendMessagePromise({type:"ready_home/barcode/lookup",barcode:t})}function ft(s,t){const e=s.trim().toLowerCase();return!e||!t?"none":(t.water_categories??[]).some(i=>i.trim().toLowerCase()===e)?"water":(t.food_categories??[]).some(i=>i.trim().toLowerCase()===e)?"food":"none"}function Qt(s,t){return t?t.expired.some(e=>e.id===s.id)?"expired":t.within_urgent.some(e=>e.id===s.id)?"urgent":t.within_expiring.some(e=>e.id===s.id)?"expiring":t.low_stock.some(e=>e.id===s.id)?"low":"":""}function Yt(s,t,e,i){let r=[...s];const o=i.search.trim().toLowerCase();if(o&&(r=r.filter(n=>n.name.toLowerCase().includes(o)||n.location.toLowerCase().includes(o)||n.category.toLowerCase().includes(o)||(n.barcode||"").toLowerCase().includes(o)||(n.notes||"").toLowerCase().includes(o))),i.filterLocation&&(r=r.filter(n=>n.location.toLowerCase()===i.filterLocation.toLowerCase())),i.filterCategory&&(r=r.filter(n=>n.category.toLowerCase()===i.filterCategory.toLowerCase())),i.filterReadiness&&(r=r.filter(n=>ft(n.category,e)===i.filterReadiness)),i.filterStatus!=="all"){const n=new Set;i.filterStatus==="expired"?t?.expired.forEach(a=>n.add(a.id)):i.filterStatus==="expiring"?(t?.within_urgent.forEach(a=>n.add(a.id)),t?.within_expiring.forEach(a=>n.add(a.id))):i.filterStatus==="low_stock"&&t?.low_stock.forEach(a=>n.add(a.id)),r=r.filter(a=>n.has(a.id))}return r.sort((n,a)=>i.sort==="quantity"?n.quantity-a.quantity:i.sort==="expiry"?(n.expiry_date||"9999").localeCompare(a.expiry_date||"9999"):n.name.localeCompare(a.name)),r}var Jt=Object.defineProperty,m=(s,t,e,i)=>{for(var r=void 0,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=n(t,e,r)||r);return r&&Jt(t,e,r),r};const Gt="ready-home-panel",Xt="/api/ready_home/brand/icon.png",te="M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z",ee="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",ie="M10,17L6,13L7.41,11.59L10,14.17L16.59,7.58L18,9M12,1L3,5V11C3,16.55 6.84,21.74 12,23C17.16,21.74 21,16.55 21,11V5L12,1Z",re="M12,20A6,6 0 0,1 6,14C6,10 12,3.25 12,3.25C12,3.25 18,10 18,14A6,6 0 0,1 12,20Z",se="M18.06 23H19.72C20.56 23 21.25 22.35 21.35 21.53L23 5.05H18V1H16.03V5.05H11.06L11.36 7.39C13.07 7.86 14.67 8.71 15.63 9.65C17.07 11.07 18.06 12.54 18.06 14.94V23M1 22V21H16.03V22C16.03 22.54 15.58 23 15 23H2C1.45 23 1 22.54 1 22M16.03 15C16.03 7 1 7 1 15H16.03M1 17H16V19H1V17Z",ct=["box","pack","piece"],oe=["gram","kilogram","liter","milliliter"],ne=["essential","important","optional"],ae={expired:"Expired",urgent:"Urgent",expiring:"Expiring",low:"Low stock"};function H(s){return s&&s.charAt(0).toUpperCase()+s.slice(1)}class f extends M{constructor(){super(...arguments),this.narrow=!1,this._snapshot=null,this._settings=null,this._search="",this._filterStatus="all",this._filterLocation="",this._filterCategory="",this._filterReadiness="",this._filtersOpen=!1,this._sort="name",this._dialogOpen=!1,this._editing=null,this._form={},this._error="",this._fieldErrors={},this._busy=!1,this._unsub=null,this._connected=!1,this._resetFilters=()=>{this._filterLocation="",this._filterCategory="",this._filterReadiness=""},this._toggleMenu=t=>{t?.stopPropagation(),this.dispatchEvent(new CustomEvent("hass-toggle-menu",{bubbles:!0,composed:!0}))},this._openAdd=()=>{this._editing=null,this._form=this._blankForm(),this._fieldErrors={},this._error="",this._dialogOpen=!0},this._openEdit=t=>{this._editing=t;const e=ct.includes(t.unit)?t.unit:"piece";let i=t.contents_per_unit,r=t.contents_unit||"",o=t.calories_per_content;i==null&&t.liters_per_unit!=null&&(i=t.liters_per_unit,r="liter"),o==null&&t.calories_per_unit!=null&&i==null&&(i=1,r=r||"gram",o=t.calories_per_unit),this._form={name:t.name,quantity:String(t.quantity),desired_quantity:String(t.desired_quantity),unit:e,location:t.location,category:t.category,priority:t.priority,notes:t.notes||"",barcode:t.barcode||"",expiry_date:t.expiry_date||"",contents_per_unit:i!=null?String(i):"",contents_unit:r,calories_per_content:o!=null?String(o):""},this._fieldErrors={},this._error="",this._dialogOpen=!0},this._closeDialog=()=>{this._dialogOpen=!1,this._fieldErrors={},this._error=""},this._onWindowKeyDown=t=>{t.key!=="Escape"||!this._dialogOpen||(t.preventDefault(),this._closeDialog())}}connectedCallback(){super.connectedCallback(),this._connected=!0,window.addEventListener("keydown",this._onWindowKeyDown),this._connect()}disconnectedCallback(){super.disconnectedCallback(),this._connected=!1,window.removeEventListener("keydown",this._onWindowKeyDown),this._unsub?.(),this._unsub=null}updated(t){t.has("hass")&&this.hass&&!this._unsub&&this._connected&&this._connect()}async _connect(){if(!(!this.hass||this._unsub))try{this._settings=await Wt(this.hass),this._unsub=await Kt(this.hass,t=>{this._snapshot=t}),this._error=""}catch(t){this._error=String(t)}}get _assessment(){return this._snapshot?.assessment??{}}get _bucketCounts(){const t=this._snapshot?.buckets;return{expired:t?.expired.length??0,expiring:(t?.within_urgent.length??0)+(t?.within_expiring.length??0),low_stock:t?.low_stock.length??0}}get _activeFilterCount(){let t=0;return this._filterLocation&&(t+=1),this._filterCategory&&(t+=1),this._filterReadiness&&(t+=1),t}_readinessKind(t){return ft(t,this._settings)}get _items(){return Yt(this._snapshot?.items??[],this._snapshot?.buckets,this._settings,{search:this._search,filterStatus:this._filterStatus,filterLocation:this._filterLocation,filterCategory:this._filterCategory,filterReadiness:this._filterReadiness,sort:this._sort})}_itemStatus(t){return Qt(t,this._snapshot?.buckets)}_statusLabel(t){return ae[t]||t}_setStatusFilter(t){this._filterStatus=this._filterStatus===t?"all":t}_pct(t){return t==null||Number.isNaN(Number(t))?"—":`${Math.round(Number(t))}%`}_formatHours(t){if(t==null||Number.isNaN(Number(t)))return"—";const e=Math.max(0,Math.round(Number(t)));return e<48?`${e}h`:`${Math.round(e/24)}d`}_formatAmount(t,e){if(t==null||Number.isNaN(Number(t)))return"—";const i=Number(t);return`${Math.abs(i-Math.round(i))<.05?Math.round(i):Math.round(i*10)/10} ${e}`}_durationClass(t){const e=this._assessment.duration_hours??this._settings?.duration_hours??72;return t==null||Number.isNaN(Number(t))?"":Number(t)<=0?"duration-bad":Number(t)<Number(e)?"duration-warn":""}_expiryClass(t){return t==="expired"?"expiry-expired":t==="urgent"||t==="expiring"?"expiry-warn":""}_formatDate(t){if(!t)return"—";const e=/^(\d{4})-(\d{2})-(\d{2})$/.exec(t.trim());if(!e)return t;const i=new Date(Number(e[1]),Number(e[2])-1,Number(e[3]));if(Number.isNaN(i.getTime()))return t;const r=this.hass?.locale,o=r?.language||this.hass?.language||navigator.language||"en",n=r?.date_format??"language",a=n==="system"?void 0:o,l=new Intl.DateTimeFormat(a,{year:"numeric",month:"numeric",day:"numeric"});if(n==="language"||n==="system")return l.format(i);const u=l.formatToParts(i),c=u.find(x=>x.type==="literal")?.value??"/",p=u.find(x=>x.type==="day")?.value??"",g=u.find(x=>x.type==="month")?.value??"",_=u.find(x=>x.type==="year")?.value??"",v=u[u.length-1],j=v?.type==="literal"?v.value:"";return n==="DMY"?`${p}${c}${g}${c}${_}${j}`:n==="MDY"?`${g}${c}${p}${c}${_}${j}`:`${_}${c}${g}${c}${p}${j}`}_optionList(t,e){const i=new Set,r=[];for(const o of[...t,e]){const n=o?.trim();if(!n)continue;const a=n.toLowerCase();i.has(a)||(i.add(a),r.push(n))}return r}_mdButton(t,e){const i=e.variant??"outlined";return h`
      <button
        type="button"
    ...
    `}render(){const t=this._items,e=this._assessment,i=this._settings?.locations??[],r=this._settings?.categories??[],o=e.overall_percent,n=e.water_percent,a=e.food_percent,l=this._bucketCounts,u=e.duration_hours??this._settings?.duration_hours??72,c=e.supply_hours,p=e.water_supply_hours,g=e.food_supply_hours;return h`
      <div class="page">
        <header class="header">
    ...
    `}_formReadiness(){return this._readinessKind(this._form.category||"")}_showContentsFields(){const t=this._formReadiness();return t==="food"||t==="water"}_showCaloriesField(){return this._formReadiness()==="food"}_renderDialog(){const t=this._form,e=this._optionList(this._settings?.locations??[],t.location||""),i=this._optionList(this._settings?.categories??[],t.category||""),r=this._formReadiness(),o=this._formTotalContents(),n=this._formTotalLiters(),a=this._formTotalCalories(),l=this._contentsUnitLabel(t.contents_unit||"unit");let u="";return o!=null&&t.contents_unit&&(u=`Total on hand: ${this._formatMeasureNumber(o)} ${l}`,n!=null&&(u+=` · ${this._formatMeasureNumber(n)} L`),a!=null&&(u+=` · ${this._formatMeasureNumber(a)} kcal`)),h`
        ...
        >
          ...
          <div class="form-section">
            ...
            <label
              ...
              >
                ${ne.map(c=>h`<option
                      value=${c}
                      ?selected=${(t.priority||"important")===c}
                    >
                      ${H(c)}
                    </option>`)}
              </select>
          ...
          <div class="form-section">
            ...
            ${this._showCaloriesField()?h`
                  <label
                    >${this._fieldLabel(`Calories (kcal) per ${l}`,!0)}
                    <input
  ...
  `}}m([F({attribute:!1})],f.prototype,"hass");m([F({type:Boolean})],f.prototype,"narrow");m([F({attribute:!1})],f.prototype,"panel");m([$()],f.prototype,"_snapshot");m([$()],f.prototype,"_settings");m([$()],f.prototype,"_search");m([$()],f.prototype,"_filterStatus");m([$()],f.prototype,"_filterLocation");m([$()],f.prototype,"_filterCategory");m([$()],f.prototype,"_filterReadiness");m([$()],f.prototype,"_filtersOpen");m([$()],f.prototype,"_sort");m([$()],f.prototype,"_dialogOpen");m([$()],f.prototype,"_editing");m([$()],f.prototype,"_form");m([$()],f.prototype,"_error");m([$()],f.prototype,"_fieldErrors");m([$()],f.prototype,"_busy");try{customElements.define(Gt,f)}catch{}
