    ...
    `}_renderRow(e){let t=this._itemStatus(e),n=this._renderMeasure(e);return M`
      <tr class=${t?`row-${t}`:``}>
        ...
        <td class="actions">
          ...
          ${this._mdButton(`Remove`,{variant:`danger-text`,disabled:this._isRemovePending(e.id),onClick:()=>void this._remove(e)})}
        </td>
      </tr>
