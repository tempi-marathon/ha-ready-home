          ...
          <section class="inventory">
            <div class="toolbar">
              <div class="toolbar-row">
                ...
                >
                  Filters${this._activeFilterCount?h` (${this._activeFilterCount})`:c}
                </button>
              </div>
              ${this._filtersOpen?h`
                    <div class="filters">
                      ...
                      ${this._activeFilterCount?this._mdButton("Reset",{variant:"text",onClick:this._resetFilters}):c}
                    </div>
                  `:c}
