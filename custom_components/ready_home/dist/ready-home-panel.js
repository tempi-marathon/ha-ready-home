        ...
        <div class="content">
          <div class="stats">
            ...
            <div class="stat">
              ...
              >
              <span class="stat-duration ${this._durationClass(y)}"
                >Lasts ${this._formatHours(y)}</span
              >
            </div>
          </div>
        ...
        >
            ...
            <div class="row2">
              <label
                ...
                <datalist id="rh-locations">
                  ${e.map(r=>p`<option value=${r}></option>`)}
                </datalist>
              </label>
              <label
                >Category
                ...
                <datalist id="rh-categories">
                  ${i.map(r=>p`<option value=${r}></option>`)}
                </datalist>
              </label>
            </div>
            <label
          ...
          <div class="form-section">
            ...
            <label
              ...
              >
                ${qt.map(r=>p`<option value=${r}>${r}</option>`)}
              </select>
            </label>
